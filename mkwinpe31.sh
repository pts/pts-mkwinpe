#! /bin/bash -- by pts@fazekas.hu at Sun Jan 14 01:57:20 CET 2018
#
# This shell script builds winpe31_x86.iso, which is Windows PE 3.1, which
# corresponds to Windows 7 SP1 (released on 2011-02-22), Windows 6.1.7601.
#
...
# -rw-r----- 1 pts pts 1353234432 Jan 14 01:38 waik_supplement_en-us.iso
...
# -rw-r----- 1 pts eng  118523904 Jan 14 02:10 winpe31_x86.iso

type -p 7z
#type -p cabextract  # Not needed.
type -p genisoimage
