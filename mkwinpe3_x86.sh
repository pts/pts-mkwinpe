...
# -rw-r----- 1 pts pts 1789542400 Jan 14  2018 KB3AIK_EN.iso
...
# -rw-r----- 1 pts pts  118276096 Jan 14  2018 winpe3_x86.iso
...
rm -rf wAIKX86.msi.x
mkdir  wAIKX86.msi.x
7z -owAIKX86.msi.x -y x wAIKX86.msi x86AIK.cab
rm -f wAIKX86.msi
7z -owAIKX86.msi.x -y x wAIKX86.msi.x/x86AIK.cab F_WINPE_X86_etfsboot.com F1_BOOTMGR F_WINPE_X86_bcd F_WINPE_X86_boot.sdi
# Alternative of the 7z call above.
...
7z -owAIKX86.msi.x -y x WinPE.cab F1_WINPE.WIM
rm -f WinPE.cab
mv wAIKX86.msi.x/F1_WINPE.WIM winpe3_x86.dir/sources/boot.wim
rm -rf wAIKX86.msi.x
